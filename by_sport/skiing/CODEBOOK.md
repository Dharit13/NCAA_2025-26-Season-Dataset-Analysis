# CODEBOOK — Skiing (NCAA 2025-26)

Per-sport slice of the NCAA All-Sports 2025-26 public dataset. Same 19-column public (de-identified, no names) schema as the master release. All files here are subsets of `data/ncaa_all_sports_rosters_2025-26.csv` — identical columns, filtered to Skiing.

## Files in this folder

| File | Scope | Rows |
|---|---|---|
| `all.csv` | all divisions, all genders | 519 |
| `men/all.csv` | men, all divisions | 266 |
| `men/d1.csv` | men, D1 | 88 |
| `men/d2.csv` | men, D2 | 39 |
| `men/d3.csv` | men, D3 | 139 |
| `women/all.csv` | women, all divisions | 253 |
| `women/d1.csv` | women, D1 | 101 |
| `women/d2.csv` | women, D2 | 39 |
| `women/d3.csv` | women, D3 | 113 |
