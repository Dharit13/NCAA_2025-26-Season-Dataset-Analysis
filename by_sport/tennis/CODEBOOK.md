...
| File | Scope | Rows |
|---|---|---|
| `all.csv` | all divisions, all genders | 14,197 |
| `men/all.csv` | men, all divisions | 6,906 |
| `men/d1.csv` | men, D1 | 2,236 |
| `men/d2.csv` | men, D2 | 1,418 |
| `men/d3.csv` | men, D3 | 3,252 |
| `women/all.csv` | women, all divisions | 7,291 |
| `women/d1.csv` | women, D1 | 2,699 |
| `women/d2.csv` | women, D2 | 1,551 |
| `women/d3.csv` | women, D3 | 3,041 |
