# CODEBOOK — Tennis (NCAA 2025-26)

Per-sport slice of the NCAA All-Sports 2025-26 public dataset. Same 19-column public (de-identified, no names) schema as the master release. All files here are subsets of `data/ncaa_all_sports_rosters_2025-26.csv` — identical columns, filtered to Tennis.

## Files in this folder

| File | Scope | Rows |
|---|---|---|
| `all.csv` | all divisions, all genders | 14,228 |
| `men/all.csv` | men, all divisions | 6,921 |
| `men/d1.csv` | men, D1 | 2,247 |
| `men/d2.csv` | men, D2 | 1,394 |
| `men/d3.csv` | men, D3 | 3,280 |
| `women/all.csv` | women, all divisions | 7,307 |
| `women/d1.csv` | women, D1 | 2,719 |
| `women/d2.csv` | women, D2 | 1,530 |
| `women/d3.csv` | women, D3 | 3,058 |
