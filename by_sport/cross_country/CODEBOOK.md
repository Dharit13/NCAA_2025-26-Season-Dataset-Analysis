# CODEBOOK — Cross Country (NCAA 2025-26)

Per-sport slice of the NCAA All-Sports 2025-26 public dataset. Same 19-column public (de-identified, no names) schema as the master release. All files here are subsets of `data/ncaa_all_sports_rosters_2025-26.csv` — identical columns, filtered to Cross Country.

## Files in this folder

| File | Scope | Rows |
|---|---|---:|
| `all.csv` | all divisions, all genders | 28,230 |
| `men/all.csv` | men, all divisions | 14,185 |
| `men/d1.csv` | men, D1 | 4,716 |
| `men/d2.csv` | men, D2 | 3,811 |
| `men/d3.csv` | men, D3 | 5,658 |
| `women/all.csv` | women, all divisions | 14,045 |
| `women/d1.csv` | women, D1 | 5,376 |
| `women/d2.csv` | women, D2 | 3,555 |
| `women/d3.csv` | women, D3 | 5,114 |
