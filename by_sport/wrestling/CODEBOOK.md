# CODEBOOK — Wrestling (NCAA 2025-26)

Per-sport slice of the NCAA All-Sports 2025-26 public dataset. Same 19-column public (de-identified, no names) schema as the master release. All files here are subsets of `data/ncaa_all_sports_rosters_2025-26.csv` — identical columns, filtered to Wrestling.

## Files in this folder

| File | Scope | Rows |
|---|---|---:|
| `all.csv` | all divisions, all genders | 10,750 |
| `men/all.csv` | men, all divisions | 8,794 |
| `men/d1.csv` | men, D1 | 2,538 |
| `men/d2.csv` | men, D2 | 2,443 |
| `men/d3.csv` | men, D3 | 3,813 |
| `women/all.csv` | women, all divisions | 1,956 |
| `women/d1.csv` | women, D1 | 158 |
| `women/d2.csv` | women, D2 | 775 |
| `women/d3.csv` | women, D3 | 1,023 |
