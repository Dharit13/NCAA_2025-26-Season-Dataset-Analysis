# CODEBOOK — Fencing (NCAA 2025-26)

Per-sport slice of the NCAA All-Sports 2025-26 public dataset. Same 19-column public (de-identified, no names) schema as the master release. All files here are subsets of `data/ncaa_all_sports_rosters_2025-26.csv` — identical columns, filtered to Fencing.

## Files in this folder

| File | Scope | Rows |
|---|---|---:|
| `all.csv` | all divisions, all genders | 1,214 |
| `men/all.csv` | men, all divisions | 588 |
| `men/d1.csv` | men, D1 | 341 |
| `men/d2.csv` | men, D2 | 20 |
| `men/d3.csv` | men, D3 | 227 |
| `women/all.csv` | women, all divisions | 626 |
| `women/d1.csv` | women, D1 | 381 |
| `women/d2.csv` | women, D2 | 9 |
| `women/d3.csv` | women, D3 | 236 |
